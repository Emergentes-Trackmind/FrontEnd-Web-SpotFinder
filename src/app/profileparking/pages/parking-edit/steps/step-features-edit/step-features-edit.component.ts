...
@Component({
  selector: 'app-step-features-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './step-features-edit.component.html',
  styleUrls: ['./step-features-edit.component.css']
})
export class StepFeaturesEditComponent implements OnInit, OnDestroy {
  ...
  private setupFormSubscription(): void {
    this.featuresForm.valueChanges
      ...
      .subscribe(value => {
        this.editService.updateFeatures(value);
      });
  }
