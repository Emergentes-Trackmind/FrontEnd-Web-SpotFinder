...
@Component({
  selector: 'app-step-location-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './step-location-edit.component.html',
  styleUrls: ['./step-location-edit.component.css']
})
export class StepLocationEditComponent implements OnInit, OnDestroy {
  @ViewChild(MapComponent) mapComponent!: MapComponent;

  locationForm!: FormGroup;
  mapCenter: MapCoordinates = { lat: 40.4168, lng: -3.7038 };
  isGeocoding = false;
  ...
  private setupFormSubscription(): void {
    this.locationForm.valueChanges
      ...
      .subscribe(value => {
        this.editService.updateLocation(value);
      });
  }
