...
@Component({
  selector: 'app-step-pricing-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './step-pricing-edit.component.html',
  styleUrls: ['./step-pricing-edit.component.css']
})
export class StepPricingEditComponent implements OnInit, OnDestroy {
  ...
  private setupFormSubscription(): void {
    this.pricingForm.valueChanges
      ...
      .subscribe(value => {
        this.editService.updatePricing(value);
      });
  }
